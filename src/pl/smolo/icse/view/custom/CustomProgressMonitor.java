 ...
 * 
 * http://javasourcecode.org/html/open-source/jdk/jdk-6u23/javax/swing/ProgressMonitor.java.html
 */
 ...
 * @version %I% %G%
 */
public class CustomProgressMonitor extends Object implements Accessible
{
	...
	// @author msmolen
	/**
	 * Czy pasek postepu wyswietla wartosci, czy 
	 */
	private boolean indeterminate;
	private String progressTitle;
	private boolean isDialogModal;
	...
	public CustomProgressMonitor(Component parentComponent, Object message, String note, int min, int max, 
			boolean indeterminate, String progressTitle, boolean isDialogModal)
	{
		this.min = min;
		this.max = max;
	...
	private class ProgressOptionPane extends JOptionPane
	{
		ProgressOptionPane(Object messageList)
		{
			super(messageList, JOptionPane.INFORMATION_MESSAGE, JOptionPane.DEFAULT_OPTION, null,
					CustomProgressMonitor.this.cancelOption, null);
		}
		...
		public JDialog createDialog(Component parentComponent, String title)
		{
			...
			dialog = new JDialog(window, title, isDialogModal);
			...
			addPropertyChangeListener(new PropertyChangeListener() {
				public void propertyChange(PropertyChangeEvent event)
				{
					if (dialog.isVisible()
							...
							&& (event.getPropertyName().equals(VALUE_PROPERTY) || event.getPropertyName().equals(
		...
		{
			return CustomProgressMonitor.this.getAccessibleContext();
		}
				...
				if (dT >= millisToDecideToPopup)
				{
					...
					if (predictedCompletionTime >= millisToPopup)
					{
						...
						dialog = pane.createDialog(
								parentComponent, 
								StringUtils.isEmpty(progressTitle) ? UIManager.getString("ProgressMonitor.progressText") : progressTitle);
						dialog.show();
					}
				}
			}
	 ...
	 * @since 1.5
	 */
	protected class AccessibleProgressMonitor extends AccessibleContext implements AccessibleText, ChangeListener,
